...
def extract_insights(text: str, max_chars: int = 4000) -> Dict[str, Any]:
    ...
    messages = [
        {"role": "system", "content": "You are a JSON-only insight extraction service. Output valid JSON object only, no explanation."},
    ...
    action_indicators = ["todo", "action item", "must", "should", "need to", "task", "assign", "deadline"]
    for line in lines:
