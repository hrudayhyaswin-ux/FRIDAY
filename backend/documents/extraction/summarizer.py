...
def generate_summary(text: str, max_chars: int = 6000) -> str:
    ...
    messages = [
        {"role": "system", "content": "You are a precise document summarizer. Keep summaries objective, structured, and informative."},
