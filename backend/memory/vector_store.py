...
class LocalVectorStore:
    def __init__(self, storage_dir: str = "knowledge"):
        ...
        self.fallback_vectors = []  # List of np.ndarray
        self.mappings = []          # List of dict: {"chunk_id": str, "document_id": str}
    ...
    def add_embeddings(self, chunk_ids: List[str], doc_ids: List[str], embeddings: List[List[float]]):
        ...
        new_mappings = [{"chunk_id": cid, "document_id": did} for cid, did in zip(chunk_ids, doc_ids)]
    ...
    def load(self):
        ...
        if os.path.exists(npy_path):
            try:
                ...
                self.fallback_vectors = [vec for vec in np_vecs]
            except Exception as e:
